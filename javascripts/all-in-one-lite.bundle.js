...
var globalFontPromises, ComponentBuilder;
var init_init = __esm({
  "dist/esm/init.mjs"() {
    init_build();
    globalFontPromises = [];
...
function preloadRemoteFonts2(userFonts, options) {
  ...
  if (options && options?.assets !== false && options?.assets?.length && options?.assets?.length > 0) {
    let assetUrlPrefix = options.assetUrlPrefix ?? "/assets/fonts/";
...
function __wbg_get_imports() {
  ...
  imports.wbg.__wbindgen_closure_wrapper21246 = function(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 9593, __wbg_adapter_48);
    return addHeapObject(ret);
  };
  return imports;
}
...
var wasm, heap, WASM_VECTOR_LEN, cachedUint8Memory0, cachedTextEncoder, encodeString, cachedInt32Memory0, heap_next, cachedTextDecoder, cachedFloat64Memory0, cachedBigInt64Memory0, cachedUint32Memory0, IncrServer, ProxyContext, TypstCompiler, TypstCompilerBuilder, typst_ts_web_compiler_default, importWasmModule;
    ...
    TypstCompiler = class {
      ...
      */
      load_snapshot(snapshot, font_cb) {
        try {
          const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
          wasm.typstcompiler_load_snapshot(retptr, this.__wbg_ptr, addHeapObject(snapshot), addHeapObject(font_cb));
          var r0 = getInt32Memory0()[retptr / 4 + 0];
          var r1 = getInt32Memory0()[retptr / 4 + 1];
      ...
      */
      modify_font_data(idx, buffer) {
        wasm.typstcompiler_modify_font_data(this.__wbg_ptr, idx, addHeapObject(buffer));
      }
      /**
      */
      rebuild() {
        wasm.typstcompiler_rebuild(this.__wbg_ptr);
      }
      /**
      * @returns {(string)[]}
      */
      ...
      */
      get_ast(main_file_path) {
        ...
        try {
          const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
          const ptr0 = passStringToWasm0(main_file_path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
          const len0 = WASM_VECTOR_LEN;
      ...
      */
      get_semantic_tokens(offset_encoding, file_path, result_id) {
        try {
          const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
          const ptr0 = passStringToWasm0(offset_encoding, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
          const len0 = WASM_VECTOR_LEN;
          var ptr1 = isLikeNone(file_path) ? 0 : passStringToWasm0(file_path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
          var len1 = WASM_VECTOR_LEN;
          var ptr2 = isLikeNone(result_id) ? 0 : passStringToWasm0(result_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
      ...
      */
      get_artifact(fmt) {
        try {
          ...
          const len0 = WASM_VECTOR_LEN;
          wasm.typstcompiler_get_artifact(retptr, this.__wbg_ptr, ptr0, len0);
          var r0 = getInt32Memory0()[retptr / 4 + 0];
          var r1 = getInt32Memory0()[retptr / 4 + 1];
          var r2 = getInt32Memory0()[retptr / 4 + 2];
          var r3 = getInt32Memory0()[retptr / 4 + 3];
      ...
      */
      query(main_file_path, selector, field) {
        ...
        try {
          ...
          const len1 = WASM_VECTOR_LEN;
          var ptr2 = isLikeNone(field) ? 0 : passStringToWasm0(field, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
          var len2 = WASM_VECTOR_LEN;
      ...
      */
      compile(main_file_path, fmt) {
        try {
          ...
          const len1 = WASM_VECTOR_LEN;
          wasm.typstcompiler_compile(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1);
          var r0 = getInt32Memory0()[retptr / 4 + 0];
          var r1 = getInt32Memory0()[retptr / 4 + 1];
          var r2 = getInt32Memory0()[retptr / 4 + 2];
          var r3 = getInt32Memory0()[retptr / 4 + 3];
      ...
      * @returns {Uint8Array}
      */
      incr_compile(main_file_path, state) {
        try {
          const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
          const ptr0 = passStringToWasm0(main_file_path, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
          const len0 = WASM_VECTOR_LEN;
          _assertClass(state, IncrServer);
          wasm.typstcompiler_incr_compile(retptr, this.__wbg_ptr, ptr0, len0, state.__wbg_ptr);
          var r0 = getInt32Memory0()[retptr / 4 + 0];
          var r1 = getInt32Memory0()[retptr / 4 + 1];
          var r2 = getInt32Memory0()[retptr / 4 + 2];
          var r3 = getInt32Memory0()[retptr / 4 + 3];
      ...
      compile(options) {
        return new Promise((resolve) => {
          if ("incrementalServer" in options) {
            resolve(this.compiler.incr_compile(options.mainFilePath, options.incrementalServer[kObject]));
            return;
          }
...
function createGlobalRenderer(creator, pdf, initOptions) {
...
function withGlobalRenderer(creator, pdf, initOptions, resolve, reject) {
...
// dist/esm/render/canvas/viewport.mjs
var PageViewport;
...
function __wbg_adapter_24(arg0, arg1, arg2) {
  _assertNum(arg0);
  _assertNum(arg1);
  wasm2._dyn_core__ops__function__Fn__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc686de09749f0c7e(arg0, arg1, addHeapObject2(arg2));
}
function __wbg_adapter_27(arg0, arg1) {
  _assertNum(arg0);
  _assertNum(arg1);
  wasm2._dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h84ed2d0e9d161250(arg0, arg1);
}
...
function __wbg_adapter_30(arg0, arg1, arg2) {
  _assertNum(arg0);
  _assertNum(arg1);
  wasm2._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd48681c41a1cf659(arg0, arg1, addHeapObject2(arg2));
}
...
function __wbg_adapter_106(arg0, arg1, arg2, arg3) {
  _assertNum(arg0);
  _assertNum(arg1);
  wasm2.wasm_bindgen__convert__closures__invoke2_mut__h738c35b381d11b40(arg0, arg1, addHeapObject2(arg2), addHeapObject2(arg3));
}
...
function __wbg_get_imports2() {
    ...
    return logError(function(arg0, arg1) {
      try {
        ...
        var cb0 = (arg02, arg12) => {
          ...
          state0.a = 0;
          try {
            return __wbg_adapter_106(a, state0.b, arg02, arg12);
          } finally {
            state0.a = a;
          }
        };
  ...
  imports.wbg.__wbindgen_closure_wrapper2295 = function() {
    return logError(function(arg0, arg1, arg2) {
      const ret = makeClosure(arg0, arg1, 697, __wbg_adapter_24);
      return addHeapObject2(ret);
    }, arguments);
  };
  imports.wbg.__wbindgen_closure_wrapper2296 = function() {
    return logError(function(arg0, arg1, arg2) {
      const ret = makeClosure(arg0, arg1, 697, __wbg_adapter_27);
      return addHeapObject2(ret);
    }, arguments);
  };
  imports.wbg.__wbindgen_closure_wrapper4002 = function() {
    return logError(function(arg0, arg1, arg2) {
      const ret = makeMutClosure2(arg0, arg1, 1644, __wbg_adapter_30);
      return addHeapObject2(ret);
    }, arguments);
  };
  return imports;
...
var wasm2, heap2, heap_next2, cachedTextDecoder2, cachedUint8Memory02, WASM_VECTOR_LEN2, cachedTextEncoder2, encodeString2, cachedInt32Memory02, cachedFloat32Memory0, cachedUint32Memory02, CreateSessionOptions, PageInfo, PagesInfo, RenderPageImageOptions, RenderSession, RenderSessionOptions, TypstRenderer, TypstRendererBuilder, typst_ts_renderer_default, importWasmModule2;
    ...
    CreateSessionOptions = class {
      ...
      */
      set format(format) {
        ...
        const ptr0 = passStringToWasm02(format, wasm2.__wbindgen_malloc, wasm2.__wbindgen_realloc);
      ...
      */
      set artifact_content(artifact_content) {
        if (this.__wbg_ptr == 0)
          throw new Error("Attempt to use a moved value");
        _assertNum(this.__wbg_ptr);
        const ptr0 = passArray8ToWasm02(artifact_content, wasm2.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN2;
      ...
      */
      set cache_key(cache_key) {
        if (this.__wbg_ptr == 0)
          throw new Error("Attempt to use a moved value");
        _assertNum(this.__wbg_ptr);
        var ptr0 = isLikeNone2(cache_key) ? 0 : passStringToWasm02(cache_key, wasm2.__wbindgen_malloc, wasm2.__wbindgen_realloc);
      ...
      */
      source_span(path) {
        try {
          ...
          const retptr = wasm2.__wbindgen_add_to_stack_pointer(-16);
          _assertNum(this.__wbg_ptr);
          const ptr0 = passArray32ToWasm0(path, wasm2.__wbindgen_malloc);
          const len0 = WASM_VECTOR_LEN2;
      ...
      */
      manipulate_data(session, action, data) {
        try {
          ...
          const ptr0 = passStringToWasm02(action, wasm2.__wbindgen_malloc, wasm2.__wbindgen_realloc);
          const len0 = WASM_VECTOR_LEN2;
          const ptr1 = passArray8ToWasm02(data, wasm2.__wbindgen_malloc);
          const len1 = WASM_VECTOR_LEN2;
      ...
      */
      session_from_artifact(artifact_content, decoder) {
        try {
          ...
          const ptr0 = passArray8ToWasm02(artifact_content, wasm2.__wbindgen_malloc);
          const len0 = WASM_VECTOR_LEN2;
          const ptr1 = passStringToWasm02(decoder, wasm2.__wbindgen_malloc, wasm2.__wbindgen_realloc);
          const len1 = WASM_VECTOR_LEN2;
...
var TypstSnippet = class {
  ...
  static async $buildR() {
    ...
    const pdfjs = this.pdfjsModule || typeof window !== "undefined" && window?.pdfjsLib;
    await this.prepareUse();
    return createGlobalRenderer2(createTypstRenderer3, pdfjs, this.exOptions);
  }
};
...
var PageViewport2 = class {
  ...
  convertToViewportPoint(x, y) {
    return PageViewport2.applyTransform([x, y], this.transform);
  }
  convertToViewportRectangle(rect) {
    const topLeft = PageViewport2.applyTransform([rect[0], rect[1]], this.transform);
    const bottomRight = PageViewport2.applyTransform([rect[2], rect[3]], this.transform);
    return [topLeft[0], topLeft[1], bottomRight[0], bottomRight[1]];
  }
  convertToPdfPoint(x, y) {
    return PageViewport2.applyInverseTransform([x, y], this.transform);
  }
};
...
function renderTextLayer2(pdfjsLib, container, pageInfos, layerList, textSourceList) {
  const containerWidth = container.offsetWidth;
  const t2 = performance.now();
  const renderOne = (layer, i) => {
    const page_info = pageInfos[i];
    ...
    const scale = Number.parseFloat(orignalScale.toFixed(4));
    layer.parentElement?.style.setProperty("--scale-factor", scale.toString());
    const viewport = new PageViewport2({
      viewBox: [0, 0, width_pt, height_pt],
      scale,
      offsetX: 0,
      offsetY: 0,
...
function createTypstRenderer2(pdf) {
  return new TypstRendererDriver2(pdf || void 0);
}
function createTypstSvgRenderer2() {
  return new TypstRendererDriver2(void 0);
}
async function rendererBuildInfo2() {
  const renderModule = await Promise.resolve().then(() => (init_wasm_pack_shim2(), wasm_pack_shim_exports2));
  return renderModule.renderer_build_info();
}
function randstr2(prefix) {
  return Math.random().toString(36).replace("0.", prefix || "");
}
...
var TypstRendererDriver2 = class {
  ...
  renderTextLayer(session, view, container, layerList, textSourceList) {
    renderTextLayer2(this.pdf, container, view.pageInfos, layerList, textSourceList);
  }
  renderAnnotationLayer(_session, view, _container, layerList, annotationSourceList) {
    const pageInfos = view.pageInfos;
    const t2 = performance.now();
...
var TypstCompilerDriver2 = class {
  ...
  compile(options) {
    return new Promise((resolve) => {
      if ("incrementalServer" in options) {
        resolve(
          this.compiler.incr_compile(options.mainFilePath, options.incrementalServer[kObject2])
        );
        return;
      }
      resolve(this.compiler.compile(options.mainFilePath, options.format || "vector"));
  ...
  async runSyncCodeUntilStable(execute) {
    for (; ; ) {
      ...
      const result = execute();
      console.log(this.compiler.get_loaded_fonts());
      if (globalFontPromises2.length > 0) {
        const promises = Promise.all(globalFontPromises2.splice(0, globalFontPromises2.length));
        const callbacks = await promises;
        for (const callback of callbacks) {
          this.compiler.modify_font_data(callback.idx, new Uint8Array(callback.buffer));
        }
...
if (window) {
  window.TypstRenderModule = {
    ...
    renderTextLayer: renderTextLayer2,
